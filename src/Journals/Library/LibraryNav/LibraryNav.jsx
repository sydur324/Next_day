...
const LibraryNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jlis" },
        { id: 2, name: "Current Issue", to: "/jlis/current-jlis" },
        { id: 3, name: "Aims & Scope", to: "/jlis/scope-jlis" },
        { id: 4, name: "Editorial Boad", to: "/jlis/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jlis/archive-jlis" },
    ]
    return (
