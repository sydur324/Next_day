...
const LanguageNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/ijll" },
        { id: 2, name: "Current Issue", to: "/ijll/current-ijll" },
        { id: 3, name: "Aims & Scope", to: "/ijll/scope-ijll" },
        { id: 4, name: "Editorial Boad", to: "/ijll/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/ijll/archive-ijll" },
    ]
    return (
