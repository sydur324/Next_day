...
const PeaceNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jgpc" },
        { id: 2, name: "Current Issue", to: "/jgpc/current-jgpc" },
        { id: 3, name: "Aims & Scope", to: "/jgpc/scope-jgpc" },
        { id: 4, name: "Editorial Boad", to: "/jgpc/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jgpc/archive-jgpc" },
    ]
    return (
