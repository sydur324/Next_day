        ...
        <div className="">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='text-lg font-medium text-[#072159]'>International Journal of Accounting and Taxation</h2>
                        <div className='py-2'>
                            <p className='font-medium text-[#91000cae] text-[15px]'>Editor-in-Chief:</p>
                            <p className='text-[15px]'>Dr. Bo Ouyang, Pennsylvania State University, USA</p>
                        </div>
                        ...
                        <div className='flex pt-2 text-[15px] flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                        ...
                        <div className='flex flex-wrap text-[15px] xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                            <p className='font-medium text-[#91000cae]'>Submission E-mail:</p>
                            <p>editor@aripd.net</p>
                        </div>

                        <div className='flex flex-wrap text-[15px] xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1 py-2'>
