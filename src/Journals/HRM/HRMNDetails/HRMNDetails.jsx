        ...
        <div className=" mt-28 page_width">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='journal_box_title'>Journal of Human Resources Management and Labor Studies</h2>
                        <div className='py-2'>
                            <p className='font-medium text-[#91000cae]'>Editor-in-Chief:</p>
                            <p>Dr. Anant R. Deshpande, School of Business, SUNY Empire State College, United States</p>
                        </div>
