...
const ComputerScienceHome = () => {
    return (
        <div className='w-full'>
            <div className='ComputerScienceHome_bg text-white px-4 py-4'>
            ...
            <div className='py-6 '>
                ...
                <p className='py-4'>
                    <span className='font-medium text-[#91000D]'>Journal of Computer Science and Information Technology</span>  provides a forum
