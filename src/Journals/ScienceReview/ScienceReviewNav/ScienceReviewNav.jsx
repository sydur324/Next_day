...
const ScienceReviewNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/ssr" },
        { id: 2, name: "Current Issue", to: "/ssr/current-ssr" },
        { id: 3, name: "Aims & Scope", to: "/ssr/scope-ssr" },
        { id: 4, name: "Editorial Boad", to: "/ssr/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/ssr/archive-ssr" },
    ]
    return (
...
export default ScienceReviewNav;