import img from '../../../assets/img/AdministrativeSciencesandPolicyStudies.png'

const PolicyStudiesDetails = () => {
    return (
        <div className="">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='text-lg font-medium text-[#072159]'>Journal of Administrative Sciences and Policy Studies</h2>
                        <div className='py-2 text-[15px]'>
                            <p className='font-medium text-[#91000cae]'>Editor-in-Chief:</p>
                            <p>Dr. Huishan Wan, University of Nebraska-Lincoln, USA.</p>
                        </div>
                        ...
                        <div className='py-2 space-y-2'>
                            <div className='flex text-[15px] flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                ...
                                <p>2372-5109 (Print Version)</p>
                            </div>

                            <div className='flex text-[15px] flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                <p className='font-medium text-[#91000cae]'>ISSN:</p>
                                <p>2372-5117 (Electronic Version)</p>
                            </div>
                        </div>
...
export default PolicyStudiesDetails;