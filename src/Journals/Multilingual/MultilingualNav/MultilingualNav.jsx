...
const MultilingualNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/imjcr" },
        { id: 2, name: "Current Issue", to: "/imjcr/current-imjcr" },
        { id: 3, name: "Aims & Scope", to: "/imjcr/scope-imjcr" },
        { id: 4, name: "Editorial Boad", to: "/imjcr/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/imjcr/archive-imjcr" },
    ]
    return (
...
export default MultilingualNav;