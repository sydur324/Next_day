import img from '../../../assets/img/InternationalStudies.png'

const ForeignLagDetails = () => {
    return (
        <div className="">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='text-lg font-medium text-[#072159]'>Journal of Foreign Languages, Cultures & Civilizations</h2>
                        <div className='py-2 text-[15px]'>
                            <p className='font-medium text-[#91000cae]'>Editor-in-Chief:</p>
                            <p>Dr. Lucia Galleno, Queens University of Charlotte, USA.</p>
                        </div>
...
export default ForeignLagDetails;