...
const JournalismBoard = () => {
    const [editorials] = useEditorials()
    const accountingEditoris = editorials.filter((editorial) => editorial.category === 'Journalism and Mass Communication')
    return (
...
export default JournalismBoard;