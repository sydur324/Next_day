...
const TechnologyNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/ijast" },
        { id: 2, name: "Current Issue", to: "/ijast/current-ijast" },
        { id: 3, name: "Aims & Scope", to: "/ijast/scope-ijast" },
        { id: 4, name: "Editorial Boad", to: "/ijast/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/ijast/archive-ijast" },
    ]
    return (
