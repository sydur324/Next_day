...
const ContemporaryGeneralBoard = () => {
    const [editorials] = useEditorials()
    const accountingEditoris = editorials.filter((editorial) => editorial.category === 'Cpi Contemporary Research')
    return (
        <div className="w-full">
            <h2 className="font-medium text-[#91000D]">Editorial Boad</h2>
...
export default ContemporaryGeneralBoard;