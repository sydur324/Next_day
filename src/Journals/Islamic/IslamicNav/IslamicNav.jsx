...
const IslamicNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jibf" },
        { id: 2, name: "Current Issue", to: "/jibf/current-jibf" },
        { id: 3, name: "Aims & Scope", to: "/jibf/scope-jibf" },
        { id: 4, name: "Editorial Boad", to: "/jibf/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jibf/archive-jibf" },
    ]
    return (
