import img from '../../../assets/img/InternationalJournalofPhilosophyandTheology.png'
        ...
        <div className="">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='text-lg font-medium text-[#072159]'>Journal of Philosophy and Theology</h2>
                        <div className='py-2 text-[15px]'>
                            <p className='font-medium text-[#91000cae]'>Editor-in-Chief:</p>
                            <p>Dr. Christopher R. Trogan, United States Merchant Marine Academy, USA.</p>
                        </div>
