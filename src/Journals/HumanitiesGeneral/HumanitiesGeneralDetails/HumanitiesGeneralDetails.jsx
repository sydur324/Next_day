import img from '../../../assets/img/bookbanner.png'

const HumanitiesGeneralDetails = () => {
    return (
                    ...
                    <div>
                        ...
                        <div className='py-2 space-y-2'>
                            <div className='flex flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                ...
                                <p>2220-8488 (Print Version)</p>
                            </div>

                            <div className='flex flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                <p className='font-medium text-[#91000cae]'>ISSN:</p>
                                <p>2221-0989 (Electronic Version)</p>
                            </div>
                        </div>
...
export default HumanitiesGeneralDetails;