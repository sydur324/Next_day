...
const StrategicNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/smq" },
        { id: 2, name: "Current Issue", to: "/smq/current-smq" },
        { id: 3, name: "Aims & Scope", to: "/smq/scope-smq" },
        { id: 4, name: "Editorial Boad", to: "/smq/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/smq/archive-smq" },
    ]
    return (
