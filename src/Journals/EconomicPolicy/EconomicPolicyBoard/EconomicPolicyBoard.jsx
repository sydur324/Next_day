...
const EconomicPolicyBoard = () => {
    const [editorials] = useEditorials()
    const accountingEditoris = editorials.filter((editorial) => editorial.category === 'Cpi Economic Policy')
    return (
...
export default EconomicPolicyBoard;