...
import JaesDetails from '../JaesDetails/JaesDetails';
import './JaesHome.css'
const JaesHome = () => {
    return (
        <div className='w-full'>
            ...
            <div className='JaseHome_bg text-white px-4 py-4 mt-8'>
            ...
            <div className='py-6 '>
                ...
                <div>
                    ...
                    <p className='text-[15px]'>
                        Each paper published in <span className='font-semibold'>Journal of Agriculture and Environmental Sciences</span> is assigned a DOI®number,
