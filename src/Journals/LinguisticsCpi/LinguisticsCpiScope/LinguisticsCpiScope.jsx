    ...
    return (
        <div className="w-full">
            ...
            <div className="py-8 gap-24">
                ...
                <p>IJLL publishes original papers, review papers, conceptual framework, analytical and simulation models, case studies, empirical research, technical notes, and book reviews. Special Issues devoted to important topics in language, literature and linguistics will occasionally be published.</p>
...
export default LinguisticsCpiScope;