...
const LinguisticsCpiNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/ijllnet" },
        { id: 2, name: "Current Issue", to: "/ijllnet/current-ijllnet" },
        { id: 3, name: "Aims & Scope", to: "/ijllnet/scope-ijllnet" },
        { id: 4, name: "Editorial Boad", to: "/ijllnet/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/ijllnet/archive-ijllnet" },
    ]
    return (
...
export default LinguisticsCpiNav;