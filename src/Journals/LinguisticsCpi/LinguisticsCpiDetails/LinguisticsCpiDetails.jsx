import img from '../../../assets/img/book (3).png'

const LinguisticsCpiDetails = () => {
    return (
        <div className=" mt-28 page_width">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='journal_box_title'>International Journal of Language & Linguistics</h2>
                        <div className='py-2'>
                        ...
                        <div className='py-2 space-y-2'>
                            <div className='flex flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                ...
                                <p>2374-8850 (Print Version)</p>
                            </div>

                            <div className='flex flex-wrap xl:flex-nowrap lg:flex-nowrap md:flex-nowrap items-center lg:space-x-2 gap-1'>
                                <p className='font-medium text-[#91000cae]'>ISSN:</p>
                                <p>2374-8869 (Electronic Version)</p>
                            </div>
                        </div>
...
export default LinguisticsCpiDetails;