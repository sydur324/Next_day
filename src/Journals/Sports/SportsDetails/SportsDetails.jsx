import img from '../../../assets/img/JournalofPhysicalEducationandSportsManagement.png'
        ...
        <div className="">
            <div className="border-2 rounded p-8">
                <div className='flex flex-wrap lg:gap-12 gap-6'>
                    ...
                    <div>
                        <h2 className='text-lg font-medium text-[#072159]'>Journal of Physical Education and Sports Management</h2>
