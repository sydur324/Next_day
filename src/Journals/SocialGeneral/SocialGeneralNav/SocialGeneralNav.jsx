...
const SocialGeneralNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/aijss" },
        { id: 2, name: "Current Issue", to: "/aijss/current-aijss" },
        { id: 3, name: "Aims & Scope", to: "/aijss/scope-aijss" },
        { id: 4, name: "Editorial Boad", to: "/aijss/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/aijss/archive-aijss" },
    ]
    return (
...
export default SocialGeneralNav;