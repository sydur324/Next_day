...
const SocialNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jsspi" },
        { id: 2, name: "Current Issue", to: "/jsspi/current-jsspi" },
        { id: 3, name: "Aims & Scope", to: "/jsspi/scope-jsspi" },
        { id: 4, name: "Editorial Boad", to: "/jsspi/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jsspi/archive-jsspi" },
    ]
    return (
