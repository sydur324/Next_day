...
const NaturalHome = () => {
    return (
        <div className='w-full'>
            <div className='NaturalHome_bg text-white px-4 py-4'>
                <h2 className='font-bold text-lg py-2'>Journal of Natural Sciences</h2>
                <div className='flex items-center space-x-2 text-sm'>
                    <p>ISSN:</p>
                    <p>2334-2943 (Print Version) / 2334-2951 (Electronic Version)</p>
                </div>
                <div className='flex items-center space-x-2 text-sm'>
                    <p>DOI:</p>
                    <p>10.15640/jns</p>
