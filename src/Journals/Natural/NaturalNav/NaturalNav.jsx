...
const NaturalNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jns" },
        { id: 2, name: "Current Issue", to: "/jns/current-jns" },
        { id: 3, name: "Aims & Scope", to: "/jns/scope-jns" },
        { id: 4, name: "Editorial Boad", to: "/jns/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jns/archive-jns" },
    ]
    return (
