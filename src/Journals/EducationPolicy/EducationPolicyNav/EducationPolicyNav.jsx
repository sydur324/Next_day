...
const EducationPolicyNav = () => {
    const journalsNav = [
        { id: 1, name: "Home", to: "/jesp" },
        { id: 2, name: "Current Issue", to: "/jesp/current-jesp" },
        { id: 3, name: "Aims & Scope", to: "/jesp/scope-jesp" },
        { id: 4, name: "Editorial Boad", to: "/jesp/editorial-board" },
        ...
        { id: 15, name: "Archive", to: "/jesp/archive-jesp" },
    ]
    return (
...
export default EducationPolicyNav;