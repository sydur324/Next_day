...
const ComputerScienceArciveTab = () => {
    const [toggle, setToggle] = useState(1)
    const toggleTab = (index) => {
        setToggle(index)
    }
    const [archives] = useArchives()
    const accountingArcives = archives.filter((archive) => archive.category === 'Computer Science')
...
export default ComputerScienceArciveTab;