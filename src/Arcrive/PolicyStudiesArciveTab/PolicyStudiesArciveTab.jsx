...
const PolicyStudiesArciveTab = () => {
    const [toggle, setToggle] = useState(1)
    const toggleTab = (index) => {
        setToggle(index)
    }
    const [archives] = useArchives()
    const accountingArcives = archives.filter((archive) => archive.category === 'Administrative Sciences')
...
export default PolicyStudiesArciveTab;