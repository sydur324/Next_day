...
const ReviewPolicy = () => {
    return (
            ...
            <div className="my-8">
                ...
                <h2 className="font-bold text-[#0D2357] aimsscope">Submission Policy</h2>
               <Link to='/Ijatnet/subscription'>
               <p className="my-6 text-[#8D0012] cursor-pointer hover:text-[#0D2357] duration-300">View the Submission Policy</p>
               </Link>
        </div>
    );
};
