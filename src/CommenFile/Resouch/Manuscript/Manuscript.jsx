        ...
        <div className="my-8">
            ...
            <div className="my-8">
                <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Name of the Journal</h2>
                        <p className="text-[#262626e2]">
                            Since ARIPD follows central submission policy for all journals (same e-mail for submission in any journal), the corresponding author is requested to mention the name of the journal in which he/she is interested to publish his/her paper.
                        </p>
                    </div>

                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Abstract</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Keywords</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Acknowledgement</h2>
                        <p className="text-[#262626e2]">
                            The author may use acknowledgement section in the title page of the paper (if any).
                        </p>

                        <h2 className="font-bold text-center text-[#91000D] py-4 cursor-pointer">View / Download a Sample Title Page</h2>
                    </div>

                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#8D0012]">4 :  Subdivision of the article</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#8D0012]">5 :  Table and Figures</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#8D0012]">6 :  References</h2>
                        <p className="text-[#262626e2]">
                            Author(s) should follow the latest edition of APA style in referencing.
                            Please visit <a href="http://www.apastyle.org/" target="_blank" className="text-[#8D0012]">www.apastyle.org</a> to learn more about APA style
                        </p>
                    </div>

                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Citations in the text</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#072159]">Reference List</h2>
                        <p className="text-[#262626e2]">
                    ...
                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#8D0012]">Examples:</h2>
                        <p className="py-1 text-[#072159]">Reference to a journal publication:</p>
                        <p className="text-[#262626e2]">
                    ...
                    <div>
                        <p className="py-1 text-[#072159]">Reference to a book:</p>
                        <p className="text-[#262626e2]">
                    ...
                    <div>
                        <p className="py-1 text-[#072159]">Reference to a chapter in an edited book:</p>
                        <p className="text-[#262626e2]">
                    ...
                    <div>
                        <p className="py-1 text-[#072159]">Reference to a web source:</p>
                        <p className="text-[#262626e2] py-2">Smith, Joe, (1999), One of Volvo's core values. [Online]</p>
                        <p className="text-[#262626e2]">Available: http://www.volvo.com/environment/index.htm (July 7, 1999)</p>
                    </div>


                    <div className="space-y-1">
                        <h2 className="font-semibold text-[#8D0012]">7 :  Submission Preparation Checklist</h2>
                        <p className="py-2 text-[#072159]">Before submitting the manuscript, author(s) should check the following list.</p>
                        <div className="my-2">
                             <ul className="space-y-2">
                                <li>1. The submission has not been previously published, nor is it before another journal for consideration.</li>
                                <li>2. The submission file is in Microsoft Word file/ PDF format.</li>
                                <li>3. Manuscript has been made in the light of Journal’s author guidelines.</li>
                                <li>4. Author(s) did not mention his or her name and affiliation in the main text</li>
                                <li>5. Author (s) has mentioned the name of the journal (in which the author is interested to publish) in title page.</li>
                                <li>6. Author(s) has read all the terms and conditions of the journal.</li>
                                <li>7. Author is aware of the publication fee of the journal</li>
                             </ul>
                        </div>
                    </div>
                    ...
                    <div className="py-8">
                        <p className="text-center text-[#91000D]">
                        STOP! Don’t submit your paper if you are not confident about the quality of your research paper. ARIPD follows double blind peer review policy strictly.
                        </p>
                    </div>
