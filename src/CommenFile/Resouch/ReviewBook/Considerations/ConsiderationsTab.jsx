            ...
            <div className="">
                <div className={toggle === 1 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px] font-medium text-[#91000D]">Character</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 2 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px] font-medium text-[#91000D] aimsscope">Theme</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 3 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px]  font-medium text-[#91000D] aimsscope">Plot</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 4 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px] font-medium text-[#91000D] aimsscope">Style</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 5 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px] font-medium text-[#91000D] aimsscope">Setting</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 6 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px]  font-medium text-[#91000D] aimsscope">Biography</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 7 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px]  font-medium text-[#91000D] aimsscope">History and other Nonfiction</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
                ...
                <div className={toggle === 8 ? "content active-content" : "content"}>
                    <div className="my-4 border px-4 py-4">
                        <h2 className="text-[15px]  font-medium text-[#91000D] aimsscope">Poetry</h2>
                        <div className="my-6 text-[15px] space-y-2 px-6 text-[#262626eb]">
