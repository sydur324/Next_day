...
const CompletedList = () => {
    const leftSubjects = [
        ...
        { id: 13, name: "International Journal of Philosophy and Theology", to: "/jlcj", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
        ...
        { id: 16, name: "Journal of Social Science for Policy Implications", to: "/jehd", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
        ...
        { id: 23, name: "Review of Arts and Humanities", to: "/jswhr", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
    ...
    const middleSubjects = [
        ...
        { id: 14, name: "Journal of Islamic Banking and Finance", to: "/jeds", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
    ...
    const lastSubjects = [
        ...
        { id: 7, name: "Journal of Natural Sciences", to: "/jpbs", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
        ...
        { id: 14, name: "International Journal of Health Sciences", to: "/jmise", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
        { id: 15, name: "International Journal of Business, Humanities and Technology", to: "/jmise", img: "https://i.ibb.co/YLF6Hx6/New-Project.jpg" },
    ]
